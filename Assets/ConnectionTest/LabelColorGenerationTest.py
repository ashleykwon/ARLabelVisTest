...
b_path = "./testBeach/beach.jpg"
b_w_l_path = "./testBeach/beachAndLabel_purple.jpg"
labelMask_path = "./testBeach/beachMask.jpg"
...
for iter in range(MAX_ITER): 
    ...
    if (iter == MAX_ITER - 1): 
        ...
        print(type(pred_img))
        output_path = "./testBeach/unblurredBG_lr0.08_itr1000.jpg"
